// src/components/RecepcionistaLayout.tsx
...
function RecepcionistaLayout() {
  ...
  const menuItems = [
    ...
    {
      path: '/dashboard/recepcionista/citas',
      icon: 'bi bi-calendar-event',
      label: 'Citas',
    },
    {
      path: '/dashboard/recepcionista/pacientes',
      icon: 'bi bi-people',
      label: 'Pacientes',
    },
    {
      path: '/dashboard/recepcionista/pagos',
      icon: 'bi bi-coin',
      label: 'Pagos',
    },
    {
      path: '/dashboard/recepcionista/mi-perfil',
      icon: 'bi bi-person',
      label: 'Mi Perfil',
    },
  ];
  ...
  const getPageTitle = () => {
    ...
    return current ? current.label : 'Panel Recepcionista';
  };
  ...
  const userName = usuario ? `${usuario.nombres} ${usuario.apellidos}` : 'Recepcionista';
              ...
              <div className="d-flex align-items-center gap-2 mb-2">
                ...
                <div>
                  ...
                  <div className="text-secondary small">
                    <i className="bi bi-person-badge me-1"></i>Recepcionista
                  </div>
                </div>
              </div>
            </div>
